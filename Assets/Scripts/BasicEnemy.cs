...
public class BasicEnemy : MonoBehaviour
{
    ...
    {
        GameBỏad.Instance.OnGameBoardChanged += OnGameBoardChange;
    }
    ...
    public void Setup(EnemyData enemyData)
    {
        ...
        currentPath = GameBỏad.Instance.SearchFromStartToEnd();
        hasSetup = true;
    }
    ...
    public void OnGameBoardChange(Node node)
    {
        ...
        if (prevNode != null)
        {
            ...
            {
                currentPath = GameBỏad.Instance.SearchPath(prevNode, GameBỏad.Instance.EndNode);
            }
            else
            {
                currentPath = GameBỏad.Instance.SearchPath(currentPath.Peek(), GameBỏad.Instance.EndNode);
            }
        }
        else
        {
